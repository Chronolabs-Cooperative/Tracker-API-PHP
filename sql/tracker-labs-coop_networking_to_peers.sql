...
--
-- Table structure for table `networking_to_peers`
--

DROP TABLE IF EXISTS `networking_to_peers`;
...
CREATE TABLE `networking_to_peers` (
  ...
  KEY `EXISTS` (`ipid`,`apiid`,`trackerid`,`torrentid`,`peerhash`) USING BTREE KEY_BLOCK_SIZE=128
