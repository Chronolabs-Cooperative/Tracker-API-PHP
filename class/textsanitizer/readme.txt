...
class MytsMycode extends MyTextSanitizerExtension
{
    ...
    function encode($textarea_id)
    {
        ...
        $code = "<img src='{$this->image_path}/mycode.gif' alt='" . _API_FORM_ALTMYCODE . "' onclick='apiCodeMycode(\"{$textarea_id}\",\"" . htmlspecialchars(_API_FORM_ENTERMYCODETERM, ENT_QUOTES) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
        $javascript = <<<EOH
            function apiCodeMycode(id, enterMycodePhrase){
