...
It simply adds a
<div class="apiQuote">your quoted text</div>
when inserting quote or
<div class="apiCode">your code</div>
...
apiQuote and apiCode
so be sure to have them inside your theme's css file or else you won't get any benefit from
this plugin.

Installation instructions:
  * Copy the "xquotecode" directory to the plugins directory of tinyeditor (/api/modules/tinyeditor/editor/plugins).
