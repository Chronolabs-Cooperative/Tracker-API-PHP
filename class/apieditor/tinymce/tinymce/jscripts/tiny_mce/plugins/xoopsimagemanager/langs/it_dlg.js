tinyMCE.addI18n('it.apiimagemanager_dlg',{
    ...
    dialog_title:"Inserisci/modifica immagine API",
    src:"URL immagine",
...
tinyMCE.addI18n('it.apiimagebrowser_dlg',{
    dialog_title:"Inserisci/gestisci immagini API",
