...
class TinyMCE
{
    ...
    public function init()
    {
        ...
        if (!($this->setting = @include($GLOBALS['api']->path('var/configs/tinymce.php')))) {
    ...
    public function loadCss($css_file = 'style.css')
    {
        ...
        if (!isset($css_url)) {
            $css_url  = dirname(api_getcss($GLOBALS['apiConfig']['theme_set']));
            $css_path = str_replace(API_THEME_URL, API_THEME_PATH, $css_url);
        }
