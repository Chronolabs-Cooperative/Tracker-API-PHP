...
class TrackerDatabaseManager
{
    ...
    {
        $this->db = TrackerDatabaseFactory::getDatabase();
        $this->db->setPrefix(Tracker_DB_PREFIX);
    }
    ...
    public function createDB()
    {
        ...
        $result = $this->db->query("CREATE DATABASE " . DB_TRACKER_NAME);
